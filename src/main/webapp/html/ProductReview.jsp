            ...
            <form action="#" method="post">
                <div class="form-group">
                    ...
                    <select id="product" name="product" required>
                        ...
                        <option value="panasonic-lumix-s5">Panasonic Lumix S5</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="review" name="review" placeholder="Chia sẻ trải nghiệm của bạn với sản phẩm này..." required></textarea>
                </div>
    ...
    <section id="reviews" class="reviews">
        ...
        <div class="review-card">
            ...
            <div class="review-content">
                <p>Máy ảnh Canon EOS R5 thực sự xuất sắc. Chất lượng hình ảnh cực kỳ sắc nét, autofocus nhanh và chính xác. Tính năng quay video 8K rất ấn tượng. Đây là khoản đầu tư xứng đáng cho nhiếp ảnh gia chuyên nghiệp.</p>
            </div>
        </div>
        ...
        <div class="review-card">
            ...
            <div class="review-content">
                <p>Sony A7 IV là một máy ảnh tuyệt vời với mức giá hợp lý. Màu sắc chân thực, cảm biến 33MP cho chất lượng hình ảnh xuất sắc. Tuy nhiên, pin hơi nhanh hết khi quay video nhiều.</p>
            </div>
        </div>
        ...
        <div class="review-card">
            ...
            <div class="review-content">
                <p>Nikon Z9 thực sự là một cỗ máy đáng kinh ngạc. Tốc độ chụp liên tục 20fps, autofocus thông minh và không có màn trập cơ học giúp loại bỏ hoàn toàn rung máy. Chất lượng video 8K cực kỳ ấn tượng.</p>
            </div>
        </div>
    </section>
</div>
