...
<nav class="nav-menu">
  ...
  <ul>
    <li class="sub">
      ...
      <div class="null">
        <ul class="sub-menu">
          <li><a href="PhuKien?cid=21" class="nav-item">ỐNG KÍNH CANON</a></li>
          <li><a href="PhuKien?cid=22" class="nav-item">ỐNG KÍNH SONY</a></li>
          <li><a href="PhuKien?cid=23" class="nav-item">ỐNG KÍNH NIKON</a></li>
          <li><a href="PhuKien?cid=24" class="nav-item">ỐNG KÍNH FUJIFILM</a></li>
          <li><a href="PhuKien?cid=25" class="nav-item">ỐNG KÍNH LUMIX</a></li>
          <li><a href="PhuKien?cid=26" class="nav-item">ỐNG KÍNH LEICA</a></li>
          <li><a href="PhuKien?cid=27" class="nav-item">ỐNG KÍNH SIGMA</a></li>
