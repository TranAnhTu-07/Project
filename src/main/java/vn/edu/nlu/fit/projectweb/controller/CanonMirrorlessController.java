...
@WebServlet(name = "CanonMirrorlessController", value = "/CanonMirrorless")
public class CanonMirrorlessController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, java.io.IOException {
        ...
        request.getRequestDispatcher("html/canon-mirrorless.jsp").forward(request, response);
    }
